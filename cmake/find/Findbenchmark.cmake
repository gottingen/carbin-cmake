...
#  CARBIN_BENCHMARK_FOUND - System has benchmark
#  CARBIN_BENCHMARK_INCLUDE_DIRS - The benchmark include directories
#  CARBIN_BENCHMARK_LIBRARIES - The libraries needed to use benchmark
...
find_library(benchmark_LIBRARY NAMES "benchmark"
        ...
        NO_DEFAULT_PATH)
find_library(benchmark_LIBRARY NAMES "benchmark" "benchmark_main")
...
if(benchmark_FOUND)
    set(CARBIN_BENCHMARK_LIBRARIES ${benchmark_LIBRARY})
    set(CARBIN_BENCHMARK_INCLUDE_DIRS ${benchmark_INCLUDE_DIR})
endif()
